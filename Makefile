...
# Time-stamp: <Dim 2013-02-24 21:34 svarrette>
#     __  __       _         __ _ _       
#    |  \/  | __ _| | _____ / _(_) | ___  
#    | |\/| |/ _` | |/ / _ \ |_| | |/ _ \
#    | |  | | (_| |   <  __/  _| | |  __/ 
...
# EncFS management
ENCFS          = $(shell which encfs)
ENCFS_RAWDIR   = $(shell pwd)/.crypt
ENCFS_MOUNTDIR = $(shell pwd)/vault
ifeq ($(UNAME),'Linux')
ENCFS_OPTS   = -o nonempty
ENCFS_UMOUNT = fusermount -u
else
ENCFS_OPTS   = 
ENCFS_UMOUNT = umount
endif
...
test:
	...
	@echo "ENCFS_RAWDIR -> $(ENCFS_RAWDIR)"
	@echo "ENCFS_MOUNTDIR -> $(ENCFS_MOUNTDIR)"
	@echo ""
...
vault_open vault_close:
	@echo "Unable to find teh encfs binary"
	@ehco "See http://www.arg0.net/encfs for more details"
else 
vault_open: 
	$(ENCFS) $(ENCFS_OPTS) --idle=1 $(ENCFS_RAWDIR) $(ENCFS_MOUNTDIR)
vault_close:
	$(ENCFS_UMOUNT) $(ENCFS_MOUNTDIR)
